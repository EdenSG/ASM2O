...
(function(a) {
    var b, c = function() {
            ...
            b.bind("showSlide", function(f, g) {
                if (!d) {
                    ...
                    "$img" in g ? e(h, g) : (d = !0, b.trigger("startLoading"), g.$img = a('<img class="slide">').css({
                        position: "absolute",
                        left: "50%",
                        top: "50%"
                    }).hide().load(function() {
                ...
                var c, d = b.data("slides"),
                    ...
                    f = e && e.id || 0;
                a.type == "nextSlide" ? c = (f + 1) % d.length : c = (f - 1 + d.length) % d.length, b.trigger("showSlide", d[c])
            });
            var e = function(a, c) {
                a !== undefined && (b.trigger("endOfSlide", a), a.$img.fadeOut()), c.$img && !c.error ? c.$img.fadeIn(function() {
                    b.trigger("startOfSlide", c)
                }) : b.trigger("startOfSlide", c), b.data("currentSlide", c)
            }, f = function(a) {
                    a.keyCode == 27 && b.trigger("close"), a.keyCode == 37 && b.trigger("prevSlide"), a.keyCode == 39 && b.trigger("nextSlide")
                };
    ...
    a.fn.fullscreenslides = function(d) {
        ...
        this.each(function() {
            ...
            d.data = a.extend({}, a(this).data(), a(c).data()), e[d.rel] = e[d.rel] || [], e[d.rel].push(d), d.id = e[d.rel].length - 1, a(c).data("slide", d), a(c).click(function(c) {
